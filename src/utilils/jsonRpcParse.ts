...
export function parseSignAminoParams(request: JsonRpcRequest): CosmosSignAminoParams | null {
    ...
    // Check validity
    if (signAddress === undefined || signDoc === undefined || chainId === undefined ||
        accountNumber === undefined || sequence === undefined || fee === undefined ||
        msgs === undefined || msgs.indexOf(null) >= 0 ||
        gas === undefined || amount === undefined || amount.indexOf(null) >= 0) {
...
export function parseSignDirectParams(request: JsonRpcRequest): CosmosSignDirectParams | null {
    const signAddress: string | undefined = request.params?.signerAddress;
    const signDoc: any | undefined = request.params?.signDoc;
    ...
    if (signAddress === undefined || signDoc === undefined || chainId === undefined ||
        accountNumber === undefined || authInfo === undefined || body === undefined) {
...
export default function parseRpcRequest(request: JsonRpcRequest): RpcRequest | null {
