					...
					<View style={styles.allocation}>
						...
						{item.type === AllocationType.Staking ? (
							<Typography.Body1 style={styles.allocationText}>
								{chainName} Staker{' '}
								{item.forboleDelegator ? '& Forbole Delegator' : ''}
							</Typography.Body1>
						) : (
							<Typography.Body1 style={styles.allocationText}>
								{chainName} LP
						...
						<Typography.Body1
							style={[
								...
								claimed ? styles.allocationClaimed : null,
							]}
						>
		...
		<StyledSafeAreaView topBar={<TopBar stackProps={{ navigation }} />}>
			...
			>
				...
				{allocations.length > 0 && (
					<Typography.Body1 style={styles.info}>
			...
			{loading || allClaimed ? null : (
				<Button
					...
					onPress={claimNow}
					disabled={
						loading || error !== null || allottedCoins === 0 || allClaimed
					}
				>
					{t('claim now')}
				</Button>
