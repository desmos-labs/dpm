...
export default class WalletConnectController {
	...
	private async saveSessionsToDisk(): Promise<void> {
		const sessions: SerializedWalletConnectSession[] = Array.from(
	 ...
	 * @private
	 */
	private async loadSessionsFromDisk(): Promise<
		SerializedWalletConnectSession[]
	> {
		try {
