...
type MsgBlockUserListItemProps = MessageListItemComponentProps<MsgBlockUserEncodeObject>;

const MsgBlockUserListItem: React.FC<MsgBlockUserListItemProps> = ({ date, message }) => {
