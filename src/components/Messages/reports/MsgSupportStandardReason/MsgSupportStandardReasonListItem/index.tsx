...
/**
 * Displays the short details of a MsgSupportStandardReason within a list.
 * @constructor
 */
const MsgSupportStandardReasonListItem: MessageListItemComponent<
  ...
  return (
    <BaseMessageListItem
      ...
      renderContent={() => (
        <View>
          <Typography.Body1>
            {t('support standard reason')} {message.value.standardReasonId.toString()}
          </Typography.Body1>
          <Typography.Caption>
...
export default MsgSupportStandardReasonListItem;
