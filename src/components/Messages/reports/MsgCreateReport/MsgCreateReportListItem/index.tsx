...
/**
 * Displays the short details of a MsgCreateReport within a list.
 * @constructor
 */
const MsgCreateReportListItem: MessageListItemComponent<MsgCreateReportEncodeObject> = ({
  message,
  date,
}) => {
  ...
  return (
    <BaseMessageListItem
      ...
      renderContent={() => (
        <View>
          <Typography.Body1>{t('create report')}</Typography.Body1>
          <Typography.Caption>
...
export default MsgCreateReportListItem;
