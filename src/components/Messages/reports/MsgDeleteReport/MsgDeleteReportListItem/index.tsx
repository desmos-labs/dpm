...
/**
 * Displays the short details of a MsgDeleteReport within a list.
 * @constructor
 */
const MsgDeleteReportListItem: MessageListItemComponent<MsgDeleteReportEncodeObject> = ({
  message,
  date,
}) => {
  ...
  return (
    <BaseMessageListItem
      ...
      renderContent={() => (
        <View>
          <Typography.Body1>
            {t('delete report')} {message.value.reportId.toString()}
          </Typography.Body1>
          <Typography.Caption>
...
export default MsgDeleteReportListItem;
