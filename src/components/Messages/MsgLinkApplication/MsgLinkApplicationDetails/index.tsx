...
type MsgLinkApplicationDetailsProps = MessageDetailsComponentProps<MsgLinkApplicationEncodeObject>;

const MsgLinkApplicationDetails: React.FC<MsgLinkApplicationDetailsProps> = ({ message }) => {
