...
type MsgUnblockUserListItemProps = MessageListItemComponentProps<MsgUnblockUserEncodeObject>;

const MsgUnblockUserListItem: React.FC<MsgUnblockUserListItemProps> = ({ date, message }) => {
