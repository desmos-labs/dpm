    ...
    const imageSource = useMemo(() => {
        ...
        if (typeOfSource === "string") {
            switch (props.source as DpmImages) {
                case "no-transaction":
                    return darkTheme ? require("../assets/no-transaction-dark.png") :
                        require("../assets/no-profile-light.png");
                case "no-profile":
                    return darkTheme ? require("../assets/no-profile-dark.png") :
                        require("../assets/no-profile-light.png");
                case "success":
                    return darkTheme ? require("../assets/result-sucess-dark.png") :
                        require("../assets/result-sucess-light.png");
                case "fail":
                    return darkTheme ? require("../assets/result-fail-dark.png") :
                        require("../assets/result-fail-light.png");
                case "no-connection":
                    return darkTheme ? require("../assets/no-connection-dark.png") :
                        require("../assets/no-connection-light.png");
                case "connect-chain":
                    return darkTheme ? require("../assets/connect_chain_dark.png") :
