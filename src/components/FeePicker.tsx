        ...
        <View style={styles.root}>
            ...
            >
                <Text
                    style={[
                        styles.optionTitle,
                        value === 'low' ? styles.selectedOptionTypography : {}
                    ]}
                >
                    {t("low fee")}
                </Text>
                <Text>
                    {feeToString(props.fees.low)}
                </Text>
            </TouchableOpacity>
            ...
            >
                <Text
                    style={[
                        styles.optionTitle,
                        value === 'average' ? styles.selectedOptionTypography : {}
                    ]}
                >
                    {t("average fee")}
                </Text>
                <Text>
                    {feeToString(props.fees.average)}
                </Text>
            </TouchableOpacity>
            ...
            >
                <Text
                    style={[
                        styles.optionTitle,
                        value === 'high' ? styles.selectedOptionTypography : {}
                    ]}
                >
                    {t("high fee")}
                </Text>
                <Text>
                    {feeToString(props.fees.high)}
                </Text>
            </TouchableOpacity>
        </View>
    );
