...
export const MessageSend: React.FC<Props> = ({
	protobufMessage,
	encodeObject,
	aminoMessage,
}) => {
	...
	const convertedAmount = useMemo(() => {
		const amount =
			protobufMessage?.amount ?? encodeObject?.amount ?? aminoMessage?.amount;
		...
		<SimpleMessageComponent
			...
			fields={[
				...
				},
				{
					label: t('to'),
					value:
						protobufMessage?.toAddress ??
						encodeObject?.toAddress ??
						aminoMessage?.to_address ??
						'',
				},
				{
					label: t('amount'),
