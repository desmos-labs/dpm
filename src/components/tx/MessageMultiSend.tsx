...
export const MessageMultiSend: React.FC<Props> = ({protobufMessage, encodeObject, aminoMessage}) => {
    ...
    const outputs = useMemo(() => {
        const outputs = protobufMessage?.outputs ?? encodeObject?.outputs ?? aminoMessage?.outputs ?? [];
    ...
    }, [chainInfo.denomUnits, encodeObject?.outputs, protobufMessage?.outputs, aminoMessage?.outputs, t]);
