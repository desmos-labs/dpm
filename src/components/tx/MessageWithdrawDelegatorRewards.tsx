...
import {AminoMsgWithdrawDelegatorReward, MsgWithdrawDelegatorRewardEncodeObject} from "@desmoslabs/sdk-core";
...
export const MessageWithdrawDelegatorRewards: React.FC<Props> = ({protobufMessage, encodeObject, aminoMessage}) => {
