...
export const SaveProfileMessage: React.FC<SaveProfileMessageProps> = ({protobufObject, encodeObject, aminoMessage}) => {
    const {t} = useTranslation();

    const profilePicture = useMemo(() => {
        const profilePicture = protobufObject?.profilePicture ?? encodeObject?.profilePicture ?? aminoMessage?.profile_picture
    ...
    const coverPicture = useMemo(() => {
        const coverPicture = protobufObject?.coverPicture ?? encodeObject?.coverPicture ?? aminoMessage?.cover_picture
